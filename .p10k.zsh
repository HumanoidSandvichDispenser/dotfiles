# Generated by Powerlevel10k configuration wizard on 2021-03-29 at 12:45 PDT.
...
# 24h time, 2 lines, solid, left frame, white-ornaments, compact, many icons, fluent,
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    newline                 # \n
    context
    dir                     # current directory (only shown in transient prompt)
  ...
  # Custom icon.
  [ "$(hostname)" = "artix" ] && typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION=' '
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@%m (SSH)'
  ...
  ############[ nodeenv: node.js environment (https://github.com/ekalinin/nodeenv) ]############
  # Nodeenv color.
  typeset -g POWERLEVEL9K_NODEENV_FOREGROUND=8
  ...
  function p10k-on-pre-prompt() {
    p10k display '1|2/left_frame'=show
    p10k display '2/left/dir|2/left/context'=hide
  }
  
  function p10k-on-post-prompt() {
    p10k display '1|2/left_frame'=hide
    p10k display '2/left/dir|2/left/context'=show
  }
