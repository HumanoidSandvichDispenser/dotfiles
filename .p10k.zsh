# Generated by Powerlevel10k configuration wizard on 2020-01-27 at 12:06 PST.
...
() {
  ...
  function prompt_packages() {
	local packages=$(<$HOME/bin/updates.txt)
    p10k segment -i '  ' -t $packages
  }
  ...
  # To disable default icons for all segments, set 
